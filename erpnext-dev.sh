...
update_toolkit() {
  ...
  mkdir -p "$lib_dir"
  for lib_file in common.sh config.sh access.sh frappe.sh support.sh backup.sh ssl.sh firewall.sh apps.sh health.sh storage.sh service.sh install.sh; do
