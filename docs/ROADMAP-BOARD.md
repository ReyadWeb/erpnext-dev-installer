...
| v1.19.14 | [#108](https://github.com/ReyadWeb/erpnext-dev-toolkit/issues/108) CLI Page UX Architecture |
...
**Current focus:** v1.19.13 post-install settle (field: styled Sign In before HTTPS, no reboot).  
**Next:** [#108](https://github.com/ReyadWeb/erpnext-dev-toolkit/issues/108) — v1.19.14 CLI Page UX.  
**Deferred:** [#62](https://github.com/ReyadWeb/erpnext-dev-toolkit/issues/62) — v1.20.0 until 1.19.13 + 1.19.14 are field-validated.
