...
| **v1.14.0** | Community polish: `CONTRIBUTING.md`, `CODE_OF_CONDUCT.md`, `SUPPORT.md`, Issue Forms, PR template, CODEOWNERS, contributor labels, Discussions + private vulnerability reporting, starter `good first issue` set. (Phase 1 contributor architecture landed on main ahead of the tag; remaining: docs/compatibility forms, DEVELOPMENT/RELEASE guides, governance as the community grows.) | **in progress** |
