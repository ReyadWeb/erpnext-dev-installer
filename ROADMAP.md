...
| **v1.14.0** | Community polish: Phase 1 (`CONTRIBUTING` / CoC / `SUPPORT`, bug+feature forms, PR template, CODEOWNERS, Discussions, private vuln reporting, starter `good first issue`s) + Phase 2 (compatibility + docs Issue Forms, `docs/DEVELOPMENT.md`, `docs/RELEASE-PROCESS.md`, community project board). Remaining later: governance ladder, module owner teams as the community grows. | **in progress** |
